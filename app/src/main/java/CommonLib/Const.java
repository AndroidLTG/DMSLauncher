...
public abstract class Const {
    ...
    public static final int LocationUpdateIntervalInSeconds = 1 * 60; // chu kì cập nhật location
    public static final int MaxRecordsLastSend = 100; // số bản ghi cuối cùng tối đa gửi lên server mỗi lần đọc csdl
